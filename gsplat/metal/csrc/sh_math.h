...
// Evaluate spherical harmonics bases at a unit direction for one color channel
// using the fast recurrence from Sloan 2013.
inline void sh_coeffs_to_color_fast(
    uint degree,
    uint c,
    float3 dir,
    device const float* coeffs,
    thread float& out_color
) {
...
// Vector-Jacobian product for sh_coeffs_to_color_fast.
inline void sh_coeffs_to_color_fast_vjp(
    uint degree,
    uint c,
    float3 dir,
    device const float* coeffs,
    ...
    v_coeffs[c] = 0.2820947917738781f * v_color;
    if (degree < 1u) {
        return;
    }
    ...
    v_coeffs[1 * 3 + c] = -0.48860251190292f * y * v_color;
    v_coeffs[2 * 3 + c] = 0.48860251190292f * z * v_color;
    v_coeffs[3 * 3 + c] = -0.48860251190292f * x * v_color;

    if (v_dir != nullptr) {
        v_x += -0.48860251190292f * coeffs[3 * 3 + c] * v_color;
        v_y += -0.48860251190292f * coeffs[1 * 3 + c] * v_color;
        v_z += 0.48860251190292f * coeffs[2 * 3 + c] * v_color;
    }
    if (degree < 2u) {
        if (v_dir != nullptr) {
    ...
    float pSH8 = 0.5462742152960395f * fC1;
    float pSH4 = 0.5462742152960395f * fS1;
    v_coeffs[4 * 3 + c] = pSH4 * v_color;
    v_coeffs[5 * 3 + c] = pSH5 * v_color;
    v_coeffs[6 * 3 + c] = pSH6 * v_color;
    v_coeffs[7 * 3 + c] = pSH7 * v_color;
    v_coeffs[8 * 3 + c] = pSH8 * v_color;

    float fTmp0B_z = 0.0f, fC1_x = 0.0f, fC1_y = 0.0f, fS1_x = 0.0f, fS1_y = 0.0f,
          pSH6_z = 0.0f, pSH7_x = 0.0f, pSH7_z = 0.0f, pSH5_y = 0.0f,
          pSH5_z = 0.0f, pSH8_x = 0.0f, pSH8_y = 0.0f, pSH4_x = 0.0f, pSH4_y = 0.0f;
    if (v_dir != nullptr) {
    ...
    float pSH15 = -0.5900435899266435f * fC2;
    float pSH9 = -0.5900435899266435f * fS2;
    v_coeffs[9 * 3 + c] = pSH9 * v_color;
    v_coeffs[10 * 3 + c] = pSH10 * v_color;
    v_coeffs[11 * 3 + c] = pSH11 * v_color;
    v_coeffs[12 * 3 + c] = pSH12 * v_color;
    v_coeffs[13 * 3 + c] = pSH13 * v_color;
    v_coeffs[14 * 3 + c] = pSH14 * v_color;
    v_coeffs[15 * 3 + c] = pSH15 * v_color;

    float fTmp0C_z = 0.0f, fTmp1B_z = 0.0f, fC2_x = 0.0f, fC2_y = 0.0f,
          fS2_x = 0.0f, fS2_y = 0.0f, pSH12_z = 0.0f, pSH13_x = 0.0f,
          pSH13_z = 0.0f, pSH11_y = 0.0f, pSH11_z = 0.0f, pSH14_x = 0.0f,
          pSH14_y = 0.0f, pSH14_z = 0.0f, pSH10_x = 0.0f, pSH10_y = 0.0f,
          pSH10_z = 0.0f, pSH15_x = 0.0f, pSH15_y = 0.0f, pSH9_x = 0.0f, pSH9_y = 0.0f;
    if (v_dir != nullptr) {
    ...
    float pSH24 = 0.6258357354491763f * fC3;
    float pSH16 = 0.6258357354491763f * fS3;
    v_coeffs[16 * 3 + c] = pSH16 * v_color;
    v_coeffs[17 * 3 + c] = pSH17 * v_color;
    v_coeffs[18 * 3 + c] = pSH18 * v_color;
    v_coeffs[19 * 3 + c] = pSH19 * v_color;
    v_coeffs[20 * 3 + c] = pSH20 * v_color;
    v_coeffs[21 * 3 + c] = pSH21 * v_color;
    v_coeffs[22 * 3 + c] = pSH22 * v_color;
    v_coeffs[23 * 3 + c] = pSH23 * v_color;
    v_coeffs[24 * 3 + c] = pSH24 * v_color;

    float fTmp0D_z = 0.0f, fTmp1C_z = 0.0f, fTmp2B_z = 0.0f,
          fC3_x = 0.0f, fC3_y = 0.0f, fS3_x = 0.0f, fS3_y = 0.0f, pSH20_z = 0.0f,
          pSH21_x = 0.0f, pSH21_z = 0.0f, pSH19_y = 0.0f, pSH19_z = 0.0f,
          pSH22_x = 0.0f, pSH22_y = 0.0f, pSH22_z = 0.0f, pSH18_x = 0.0f,
          pSH18_y = 0.0f, pSH18_z = 0.0f, pSH23_x = 0.0f, pSH23_y = 0.0f,
          pSH23_z = 0.0f, pSH17_x = 0.0f, pSH17_y = 0.0f, pSH17_z = 0.0f,
          pSH24_x = 0.0f, pSH24_y = 0.0f, pSH16_x = 0.0f, pSH16_y = 0.0f;
    if (v_dir != nullptr) {
